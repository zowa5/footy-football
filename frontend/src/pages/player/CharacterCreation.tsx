...
export default function CharacterCreation({
  ...
  useEffect(() => {
    if (!isLoading && user && user.playerInfo) {
      navigate("/player");
    }
  ...
  const initializeStats = (positionId: string) => {
    ...
    PLAYER_ATTRIBUTES.forEach((attr) => {
      const baseValue =
        position.baseStats[attr.id as keyof typeof position.baseStats] ||
        attr.min;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Design your ultimate football player
          </p>
        </div>
          ...
          <CardContent className="p-8">
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">
                    Start with your player's name and position
                  </p>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">
                    Distribute {availablePoints} remaining points across your
                    attributes
                  </p>
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold mb-2">
                    Skills & Playing Styles
                  </h2>
                  <p className="text-muted-foreground">
                    Choose 3 skills and 3 playing styles
                  </p>
                </div>
                ...
                <Tabs defaultValue="skills" className="w-full">
                  ...
                  <TabsContent value="styles" className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {getPositionStyles(characterData.position)
                        .slice(0, 12)
                        .map((style) => (
                          <Card
                            key={style.id}
                            ...
                            onClick={() => {
                              if (
                                ...
                                setCharacterData((prev) => ({
                                  ...prev,
                                  playingStyles: prev.playingStyles.filter(
                                    (s) => s !== style.id
                                  ),
                                }));
                              } else if (
                          ...
                          >
                            <CardContent className="p-4">
                              <div className="flex items-center justify-between">
                                ...
                                {characterData.playingStyles.includes(
                                  style.id
                                ) && <Check className="h-5 w-5 text-primary" />}
                              </div>
                            </CardContent>
            ...
            {currentStep === 5 && (
              <div className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">
                    Choose 3 team playing styles that suit your gameplay
                  </p>
                </div>
                    ...
                    <Card
                      ...
                      onClick={() => {
                        if (characterData.comStyles.includes(style.id)) {
                          setCharacterData((prev) => ({
                            ...prev,
                            comStyles: prev.comStyles.filter(
                              (s) => s !== style.id
                            ),
                          }));
            ...
            <div className="flex justify-between mt-8">
              ...
              {currentStep === totalSteps ? (
                ...
                <Button
                  ...
                  disabled={
                    (currentStep === 1 &&
                      (!characterData.name || !characterData.position)) ||
                    (currentStep === 4 &&
                      (characterData.skills.length !== 3 ||
                        characterData.playingStyles.length !== 3))
                  }
